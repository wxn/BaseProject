...
@interface FGalleryViewController : BaseNextViewController <UIScrollViewDelegate,FGalleryPhotoDelegate,FGalleryPhotoViewDelegate> {
	...
	UIView *_container; // used as view for the controller
	 // sized and placed to be fullscreen within the container
	UIToolbar *_toolbar;
