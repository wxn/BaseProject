...
- (id)initWithFrame:(CGRect)frame
{
    ...
    UIImageView* mainImageView= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 100, 85)];
    mainImageView.animationImages = [NSArray arrayWithObjects:
                                     [UIImage imageNamed:@"loading1"],
                                     [UIImage imageNamed:@"loading2"],nil];
    [mainImageView setAnimationDuration:0.1f];
    [mainImageView setAnimationRepeatCount:0];
    [mainImageView startAnimating];
    
    UIImageView* titleImageView= [[UIImageView alloc]initWithFrame:CGRectMake(-20, 85, 140, 15)];
    titleImageView.image = [UIImage imageNamed:@"loading3"];
    
    [self.loadingView addSubview:titleImageView];
    [self.loadingView addSubview:mainImageView];
...
- (void)setFrame:(CGRect)theFrame
{
    ...
    [self.loadingView setCenter:CGPointMake(theFrame.size.width * .5, theFrame.size.height * .5)];
