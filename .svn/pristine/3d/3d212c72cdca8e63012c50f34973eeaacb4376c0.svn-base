...
- (void)viewDidLoad {
    ...
    self.addImageView = [[UIView alloc]initWithFrame:CGRectMake(0, 10, Screen_Width, 170)];
    ...
    UIButton *sureBtn = [[UIButton alloc]initWithFrame:CGRectMake(SpaceLeftRight, CGRectGetMaxY(infotable.frame)+30, (Screen_Width-2*SpaceLeftRight), 50)];
