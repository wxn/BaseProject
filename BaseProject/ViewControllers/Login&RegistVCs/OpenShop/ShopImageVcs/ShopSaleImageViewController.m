...
@interface ShopSaleImageViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,UITextFieldDelegate,ZLPhotoPickerBrowserViewControllerDelegate>{
    NSArray *titleArr;
