...
- (void)setNavigationBar {
    ...
    [self.navigationController.navigationBar setBackIndicatorImage:[UIImage imageNamed:@"navi_back_white"]];
    [self.navigationController.navigationBar setBackIndicatorTransitionMaskImage:[UIImage imageNamed:@"navi_back_white"]];
    ...
    self.navigationController.navigationBar.barTintColor = ColorWithHexString(ColorText_Blue34aeff);
